...
func (util *VsphereDiskUtil) CreateVolume(v *vsphereVolumeProvisioner, selectedAvailabilityZone []string) (volSpec *VolumeSpec, err error) {
	var fstype string
	...
	volumeOptions := &vclib.VolumeOptions{
        ...
        volumeOptions.AvailabilityZone = selectedAvailabilityZone
