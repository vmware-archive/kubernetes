...
type VolumeSource struct {
	...
	// PhotonControllerDisk represents a persistentDisk that should populate this volume
	PhotonControllerDisk *PhotonControllerPersistentDiskSource `json:"photonControllerDisk,omitempty"`
}
...
//
// A Photon Controller Persistent Disk must exist before mounting to
// a container. The disk must also be in the same Project as the kubelet.
// A Photon Controller can only be mounted as read/write once.
// Photon Controller Persistent Disks support ownership management
// and SELinux relabeling.
type PhotonControllerPersistentDiskSource struct {
